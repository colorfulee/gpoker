package com.jzgame.view.windows.safeBox
{
	...
	public class SafeBoxGetView extends Sprite
	{
		/***********
				...
				switch(touch.phase)
				{
					...
					case TouchPhase.MOVED:
						if(_start)
						{
							...
							_tip.text = Math.floor(_bank * (_pin.x - 20) / (785-_pin.width - 20)) ;
		...
		{
			return Math.floor(_bank * (_pin.x - 20) / (785-_pin.width - 20));
		}
