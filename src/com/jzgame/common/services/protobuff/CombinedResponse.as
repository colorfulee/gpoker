package com.jzgame.common.services.protobuff {
	...
	public dynamic final class CombinedResponse extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const TABLEINFO:FieldDescriptor$TYPE_MESSAGE = new FieldDescriptor$TYPE_MESSAGE("com.jzgame.common.services.protobuff.CombinedResponse.tableinfo", "tableinfo", (1 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return com.jzgame.common.services.protobuff.TableInfo; });
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (tableinfo$count != 0) {
						throw new flash.errors.IOError('Bad data format: CombinedResponse.tableinfo cannot be set twice.');
					}
					++tableinfo$count;
