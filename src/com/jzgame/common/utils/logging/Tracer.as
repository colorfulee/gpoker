package com.jzgame.common.utils.logging
{
...
public class Tracer
{
     ...
     */
    public static const logger:Logger = Logger.getLogger("global");
     ...
     *  </listing>
     */
    public static function debug(message:*, ... rest):void
    {
     ...
     *  </listing>
     */
    public static function fatal(message:*, ... rest):void
    {
     ...
     *  </listing>
     */
    public static function info(message:*, ... rest):void
    {
     ...
     *  </listing>
     */
    public static function warn(message:*, ... rest):void
    {
     ...
     *
     */
    private static function log(level:LogLevel, message:*, rest:Array):void
    {
        if(ENABLED)
        {
			trace(message);
