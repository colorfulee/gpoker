...
{
	import com.jzgame.common.utils.logging.publishers.TracePublisher;
	 ...
	 *
	 * @author Rakuten
	 * @see com.jzgame.util.logging.LogLevel
	 * @see com.jzgame.util.logging.ILogPublisher
	 */
	public class Logger
	{
		//==========================================================================
		 ...
		 * the all loggers map.
		 */
		private static const loggerMap:Object = new Object();
